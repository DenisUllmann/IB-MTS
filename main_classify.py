...
class Settings(object):
    def __init__(self):
        ...
        self.dataset_address = os.path.join("C:\\","Users","Denis","Documents","IRIS","iris_level_2C") # "The path of dataset")
        ...
        self.labels = '_'.join(['QS','AR','PF','FL']) # "label for training ['QS','AR','PF','FL']")
        self.nolabel = 'nolabel' # "allow to sample from unlabeled data and label it eg. 'nolabel'")
        self.classes = '_'.join(['QS']) # "labels of classification ['QS','AR','PF','FL'] OR ['QS','AR-PF-FL']..")
        ...
        self.checkpoint_dir = os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str( self.name),"checkpoint") # "Directory name to save the checkpoints [checkpoint]")
        self.logs_dir = os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str( self.name),"log") # "Directory name to save the log [log]")
        self.sample_dir = os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str( self.name),"samples") # "Directory name to save the image samples [samples]")
...
# # TODO change dataset_address and all 'C:/Users/../'
# # flags.DEFINE_string("dataset_address", 'C:/Users/CUI/ML/IRIS_predspectra_final/data_draft/iris_level_2C', "The path of dataset")
# flags.DEFINE_string("dataset_address", os.path.join("C:\\","Users","Denis","Documents","IRIS","iris_level_2C"), "The path of dataset")
...
# flags.DEFINE_string("classes", '_'.join(['QS','AR','PF','FL']), "labels of classification ['QS','AR','PF','FL'] OR ['QS','AR-PF-FL']..")
...
# flags.DEFINE_string("checkpoint_dir", os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str(flags.FLAGS.name),"checkpoint"), "Directory name to save the checkpoints [checkpoint]")
# flags.DEFINE_string("logs_dir", os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str(flags.FLAGS.name),"log"), "Directory name to save the log [log]")
# flags.DEFINE_string("sample_dir", os.path.join("C:\\","Users","Denis","ML","IRIS_predspectra_intermediate_new",str(flags.FLAGS.name),"samples"), "Directory name to save the image samples [samples]")
