...
flags.DEFINE_string("dataset_address", os.path.join(FLAGS.root_adress, "iris_level_2C"), "The path of dataset")
...
flags.DEFINE_string("checkpoint_dir", os.path.join(FLAGS.root_adress, str( self.name),"checkpoint"), "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("logs_dir", os.path.join(FLAGS.root_adress, str( self.name),"log"), "Directory name to save the log [log]")
flags.DEFINE_string("sample_dir", os.path.join(FLAGS.root_adress, str( self.name),"samples"), "Directory name to save the image samples [samples]")
